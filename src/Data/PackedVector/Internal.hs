...
module Data.PackedVector.Internal (
  DynamicNat(..)
, PackedVector(..)
, Mutable
, PVector(..)
...
import Data.PackedVector.Mutable (DynamicNat(..))
import Data.PackedVector.Mutable.Internal (MutablePackedVector(..), MPVector)
import Control.Monad.Primitive
import Foreign.ForeignPtr (ForeignPtr)
import Data.Word
import qualified Data.PackedVector.Mutable as M
import GHC.TypeLits
import Data.Proxy
